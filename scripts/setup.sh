...
echo "   Development: ./start build && ./start up"
echo "   Production:  sudo ./start --prod build && sudo ./start --prod up"
echo "3. Initialize database:"
echo "   Development: ./start makemigrations && ./start migrate && ./start initdata"
echo "   Production:  sudo ./start --prod makemigrations && sudo ./start --prod migrate && sudo ./start --prod initdata"
